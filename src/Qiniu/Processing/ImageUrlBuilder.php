...
final class ImageUrlBuilder
{
    ...
    public function waterImg(
        ...
        $waterStr = 'watermark/1/image/' . \QiniuOSS\base64_urlSafeEncode($image) . '/';
    ...
    public function waterText(
        ...
        $waterStr = 'watermark/2/text/'
            . \QiniuOSS\base64_urlSafeEncode($text) . '/font/'
            . \QiniuOSS\base64_urlSafeEncode($font) . '/';
        ...
        if (!is_null($fontColor)
            ...
            $waterStr .= 'fill/' . \QiniuOSS\base64_urlSafeEncode($fontColor) . '/';
        }
