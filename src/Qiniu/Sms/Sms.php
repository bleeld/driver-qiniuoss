...
class Sms
{
    ...
    public function querySendSms(
        ...
        $query = array();
        \QiniuOSS\setWithoutEmpty($query, 'job_id', $job_id);
        \QiniuOSS\setWithoutEmpty($query, 'message_id', $message_id);
        \QiniuOSS\setWithoutEmpty($query, 'mobile', $mobile);
        \QiniuOSS\setWithoutEmpty($query, 'status', $status);
        \QiniuOSS\setWithoutEmpty($query, 'template_id', $template_id);
        \QiniuOSS\setWithoutEmpty($query, 'type', $type);
        \QiniuOSS\setWithoutEmpty($query, 'start', $start);
        \QiniuOSS\setWithoutEmpty($query, 'end', $end);
        \QiniuOSS\setWithoutEmpty($query, 'page', $page);
        \QiniuOSS\setWithoutEmpty($query, 'page_size', $page_size);
