...
final class CdnManager
{
    ...
    public function getCdnRefreshList(
        ...
        $req = array();
        \QiniuOSS\setWithoutEmpty($req, 'requestId', $requestId);
        \QiniuOSS\setWithoutEmpty($req, 'isDir', $isDir);
        \QiniuOSS\setWithoutEmpty($req, 'urls', $urls);
        \QiniuOSS\setWithoutEmpty($req, 'state', $state);
        \QiniuOSS\setWithoutEmpty($req, 'pageNo', $pageNo);
        \QiniuOSS\setWithoutEmpty($req, 'pageSize', $pageSize);
        \QiniuOSS\setWithoutEmpty($req, 'startTime', $startTime);
        \QiniuOSS\setWithoutEmpty($req, 'endTime', $endTime);
